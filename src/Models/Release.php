...
{
    /** @use HasFactory<\Database\Factories\Playground\Matrix\Models\ReleaseFactory> */
    use HasFactory;

    protected $table = 'matrix_releases';
